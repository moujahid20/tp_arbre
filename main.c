...
int main()
{
    ...
    pArbre* R=NULL;
    R=inserer_arb_rec(R,5 );
    R=inserer_arb_rec(R,5 );
    R=inserer_arb_rec(R,-12 );
    R=inserer_arb_rec(R,5 );
    R=inserer_arb_rec(R,56);
    R=inserer_arb_rec(R,34 );
    R=inserer_arb_rec(R,2 );
    inserer_arb_ite(&R,3 );
    R=inserer_arb_rec(R,1 );
    R=inserer_arb_rec(R,1);
    R=inserer_arb_rec(R,9 );
    R=inserer_arb_rec(R,-2 );
    R=inserer_arb_rec(R,9 );
   if(!R)
    printf("Arbre vide");
  ...
  {
      Aff_Arbre_horiz(R,hauteur(R));
      printf("\n");
  }
    printf("\n%d",rechercher(R,23));
  printf("\n%d",rechercher(R,-12));
  printf("\nTaille=%d",Taille_Arb(R));
  printf("\nmin=%d",minArb(R)->val);
  printf("\nmax=%d",maxArb(R)->val);
  printf("\nHauteur=%d",hauteur(R));
  if(!R)
